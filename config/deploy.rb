...
namespace :deploy do
  ...
  task :check_revision, roles: :web do
    unless `git rev-parse HEAD` == `git rev-parse origin/master` || `git rev-parse HEAD` == `git rev-parse origin/develop`
      puts 'WARNING: HEAD is not the same as origin/master or origin/develop'
